...
Page {
    ...
    onIsCollapsedChanged: {
        edgeLoader.item.expanded = !isCollapsed
    }
    ...
    UbuntuShape {
        ...
        visible: page.bottomEdgeEnabled && !Qt.inputMethod.visible
        anchors {
    ...
    MouseArea {
        ...
        drag {
            axis: revealed ? Drag.None : Drag.YAxis
            target: bottomEdge
            minimumY: bottomEdge.pageStartY
            maximumY: page.height
        }
        enabled: edgeLoader.status == Loader.Ready && !Qt.inputMethod.visible
        ...
        onReleased: {
            ...
            if (revealed) {
                ...
                bottomEdge.state = "collapsed"
            } else if ((dragDirection === "BottomToTop") &&
        ...
        onMouseYChanged: {
            ...
            if (tabsModel.count > 1 &&// dragDirection === "BottomToTop" &&
                page.height + mouse.y < (page.height - page.height/3) + units.gu(9) &&
                page.height + mouse.y > (page.height - page.height/3) - units.gu(1)) {
                revealed = true
            } else if (revealed){
                revealed = false
                bottomEdge.y = page.height + mouse.y
            }
        }
    }
    ...
    Rectangle {
        ...
        states: [
            ...
            State {
                name: "floating"
                when: mouseArea.drag.active && !mouseArea.revealed
                PropertyChanges {
                    target: shadow
                    opacity: 1.0
                }
            ...
            State {
                ...
                PropertyChanges {
                    target: bottomEdge
                    y: (page.height - page.height/3) - units.gu(1)
                }
            }
        ]
